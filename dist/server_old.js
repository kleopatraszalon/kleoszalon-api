...
const allowedOrigins = [
    ...
    // ha van másik publikus frontend (pl. weblap), tedd hozzá:
...
const corsOptions = {
    origin: (origin, cb) => {
        // Postman/curl esetén origin lehet undefined
        if (!origin)
            return cb(null, true);
...
// Render / reverse proxy miatt cookie-s auth esetén erősen ajánlott:
app.set("trust proxy", 1);
// CORS MINDIG a route-ok előtt!
app.use((0, cors_1.default)(corsOptions));
// Preflight kezelése globálisan (ez szokta megoldani a 404 + hiányzó header kombót)
