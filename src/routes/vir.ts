...
import virP18Router from "./virP18";
import virP19Router from "./virP19";
import virP20Router from "./virP20";
import virP21Router from "./virP21";
import virP22Router from "./virP22";
...
// Régebbi munkamenetekben nem minden esetben szerepel tenant_id. A VIR előtt
// feloldjuk a tenantot a hitelesített telephelyből/SaaS-tagságból. Ez csak a
// request contextet javítja, a tenant- és telephelyhatárokat nem szélesíti.
...
router.use("/p18", virP18Router);
router.use("/p19", virP19Router);
router.use("/p20", virP20Router);
router.use("/p21", virP21Router);
router.use("/p22", virP22Router);
