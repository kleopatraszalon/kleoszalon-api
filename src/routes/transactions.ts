...
router.use("/loyalty-cashier",requireFeature("finance"),requireMenuPermissionByMethod("finance.checkout"),loyaltyCashierRouter);
...
router.use("/nav-online-invoice",requireFeature("finance"),requireMenuPermissionByMethod("finance"),navInvoiceLifecycleRouter);
