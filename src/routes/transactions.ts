...
import automaticRetailEInvoiceRouter from "./automaticRetailEInvoice";
...
import automaticEInvoicePolicyRouter from "./automaticEInvoicePolicy";
...
router.use("/cashier",workOrderFinanceScope,ensureFinanceReady,guardOpenCashierShift,requireFeature("finance"),requireMenuPermissionByMethod("finance.checkout"),automaticRetailEInvoiceRouter);
...
router.use("/workorder-finalization",workOrderFinanceScope,requireFeature("finance"),requireMenuPermissionByMethod("finance.checkout"),automaticEInvoicePolicyRouter);
