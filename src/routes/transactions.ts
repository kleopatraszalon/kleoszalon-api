...
router.use("/loyalty-cashier",workOrderFinanceScope,guardSettlementLifecycle,ensureFinanceReady,requireFeature("finance"),requireMenuPermissionByMethod("finance.checkout"),loyaltyCashierRouter);
