...
-- This migration replaces runtime DDL previously performed by ensureSaasCore
-- and ensureTenantIsolation. It is intentionally idempotent so an existing
-- Kleopátra installation can adopt the migration ledger safely.
...
BEGIN
  ...
  -- Existing user accounts receive an explicit migration-time membership.
  -- Runtime authorization never recreates this fallback implicitly.
