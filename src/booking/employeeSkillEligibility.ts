...
export async function employeeSkillEligibility(
  ...
  // Backward compatibility: employees with no configured override rows retain
  // the historic unrestricted behavior until HR makes the skill matrix authoritative.
