...
app.use("/api/transactions/procurement-workflow",locationManagerScope("procurement"));
...
app.use("/api/appointments",locationManagerScope("appointments"),appointmentsRouter);
app.use("/api/timetable",locationManagerScope("timetable"),timetableSelfAccess,timetableRouter);
...
app.use("/api/checklists",locationManagerScope("checklists"),checklistsRouter);
