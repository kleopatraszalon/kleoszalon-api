...
function sendLoginCodeEmail(to, code) {
    return __awaiter(this, void 0, void 0, function () {
        var mailOptions, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    mailOptions = {
                        from: "\"Kleop\u00E1tra Szalon\" <".concat(user, ">"),
                        to: to,
                ...
                case 1:
                    _a.sent();
                    console.log("\uD83D\uDCE7 K\u00F3d elk\u00FCldve: ".concat(to));
                    return [3 /*break*/, 3];
                case 2:
                    err_1 = _a.sent();
                    console.error("❌ E-mail küldés hiba:", err_1);
                    throw err_1;
