...
export function ensureProcurementReceiptCostIntegrity(): Promise<void> {
  ...
  ready = db.query(`
    ...
    CREATE INDEX IF NOT EXISTS procurement_receipt_costs_document_idx ON procurement_receipt_costs(document_number);
