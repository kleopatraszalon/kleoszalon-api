  ...
  if(!ensurePromise){
    ensurePromise=(async()=>{
      ...
      for(const file of [
        ...
        '20260817_SAAS_LIFECYCLE_POLICY_V9.sql',
        '20260816_FRANCHISE_FINANCE_V5.sql',
        '20260816_FRANCHISE_ACCOUNTING_V6.sql',
        '20260816_ENTERPRISE_MARKETING_BRIDGE_V7A.sql',
        '20260816_ENTERPRISE_INTEGRITY_V7.sql',
        '20260816_WORKORDER_REVERSAL_API_V8.sql',
        '20260816_CRM_LOYALTY_INTEGRITY_V9.sql',
