...
test('skill guard is mounted before public booking handlers', () => {
...
test('skill eligibility enforces can_perform and qualification expiry', () => {
...
test('invalid direct booking is blocked and availability is filtered', () => {
